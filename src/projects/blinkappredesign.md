    ...
    blocks:
      - type: text
        body: >-
          ...
          WiFi security camera system used by millions of customers to keep an
          eye on their homes. The mobile app is currently the only way users
          interact with Blink products. In the app, users can check a camera's
