...
sections:
  ...
  - heading: The Challenge
    blocks:
      - type: text
        body: >
          We focused on two screens that sit at the heart of daily use in the
          app: the Home screen, which is the default landing page and houses
          access to all of a user's cameras, and the Clip List, where users
          browse recordings of events that occurred on their cameras. Together,
