...
summary: As a designer on the Blink mobile app, I helped reimagine two of the app's most critical screens — Home and Clip List — modernizing the experience for tens of millions of customers who rely on them every day.
...
cardThumb: /projects/blinkappredesign/images/blinkapp-thumb.png
sections:
  - heading: Background
    blocks:
      - type: text
        body: |
          Amazon's [Blink](https://blinkforhome.com) is a home security camera system used by tens of millions of customers to monitor their homes, receive motion alerts, and review recorded events. The mobile app is the primary way people interact with their cameras — checking live views, arming their system, and reviewing clips when something happens.
  ...
  - heading: Home Screen
    blocks:
      ...
      - type: images
        items:
          - src: images/home-action-sheet-new.png
  ...
  - heading: Clip List
    blocks:
      ...
      - type: images
        items:
          - src: images/clips-previous.png
            caption: The previous Clip List
          - src: images/clips-new.png
      ...
      - type: images
        items:
          - src: images/clips-selection-new.png
